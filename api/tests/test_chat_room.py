...
from api.chat_room import app, ChatRoomCreate, TaskDescription, Participant
...
@pytest.mark.asyncio
async def test_get_chat_room(client, sample_task, sample_personality, sample_participants):
    # First create a room
    room_data = ChatRoomCreate(
        task=sample_task,
        personality=sample_personality,
